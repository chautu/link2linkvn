...
$router->map('GET|POST', '[a:com]/[a:lang]/', 'ngon-ngu', 'lang');
...
else if(!isset($_SESSION['lang']) && !isset($match['params']['lang'])) $_SESSION['lang'] = $config['website']['lang-default'];
$lang = $_SESSION['lang'];

/* Slug lang */
$sluglang = 'tenkhongdau'.$config['website']['lang-default'];

/* SEO Lang */
$seolang = $config['website']['lang-default'];
