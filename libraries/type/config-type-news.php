<?php
    ...
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.svg|.SVG|.webp|.WEBP';
    ...
    $config['news'][$nametype]['img_type_list'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.svg|.SVG|.webp|.WEBP';
    ...
    // $config['news'][$nametype]['img_type_cat'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.svg|.SVG|.webp|.WEBP';

    
    /* Banking */
    $nametype = "bank";
    $config['news'][$nametype]['title_main'] = "Ngân hàng";
    $config['news'][$nametype]['dropdown'] = true;
    $config['news'][$nametype]['list'] = true;
    $config['news'][$nametype]['cat'] = false;
    $config['news'][$nametype]['item'] = false;
    ...
    $config['news'][$nametype]['show_images'] = true;
    $config['news'][$nametype]['gallery'] = array();
    $config['news'][$nametype]['stk'] = true;
    $config['news'][$nametype]['chutk'] = true;
    $config['news'][$nametype]['mota'] = true;
    ...
    /* Banking (List) */
    $config['news'][$nametype]['title_main_list'] = "Danh mục Ngân hàng";
    $config['news'][$nametype]['images_list'] = true;
    $config['news'][$nametype]['show_images_list'] = true;
    $config['news'][$nametype]['slug_list'] = false;
    $config['news'][$nametype]['check_list'] = array();
    $config['news'][$nametype]['gallery_list'] = array();
    $config['news'][$nametype]['code_list'] = true;
    $config['news'][$nametype]['mota_list'] = true;
    $config['news'][$nametype]['mota_cke_list'] = false;
    $config['news'][$nametype]['noidung_list'] = false;
    $config['news'][$nametype]['noidung_cke_list'] = false;
    $config['news'][$nametype]['seo_list'] = false;
    $config['news'][$nametype]['width_list'] = 75;
    $config['news'][$nametype]['height_list'] = 35;
    $config['news'][$nametype]['thumb_list'] = '75x35x1';
    $config['news'][$nametype]['img_type_list'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.svg|.SVG|.webp|.WEBP';
