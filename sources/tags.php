...
{
	/* Lấy tag detail */
	$tags_detail = $d->rawQueryOne("select id, ten$lang as ten, type, photo, $sluglang from #_tags where id = ? and type = ? limit 0,1",array($id,$type));
	...
	/* Column for sản phẩm */
	if($table == 'product') $col = "photo, ten$lang as ten, $sluglang, giamoi, gia, giakm, id";

	/* Column for bài viết */
	if($table == 'news') $col = "photo, ten$lang as ten, $sluglang, mota$lang as mota, noidung$lang as noidung, ngaytao, id";
