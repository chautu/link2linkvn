...
<?php if ($type == 'video-fotorama') {
    $videonb = $d->rawQuery("select link_video, id, ten$lang from #_photo where type = ? and act <> ? and noibat > 0 and hienthi > 0 order by stt, id desc", array('video', 'photo_static'));
	if (count($videonb)) { ?>
            <!-- Video Fotorama -->
        <div id="fotorama-videos" data-width="100%" data-thumbmargin="5" data-height="360" data-fit="cover"
            data-thumbwidth="100" data-thumbheight="85" data-allowfullscreen="false" data-nav="thumbs">
...
if ($type == 'video-select') {
	...
	if (count($videonb)) { ?>
        ...
        <div class="video-main">
            <iframe width="100%" height="100%" src="//www.youtube.com/embed/<?= $func->getYoutube($videonb[0]['link_video']) ?>"
                frameborder="0" allowfullscreen></iframe>
        </div>
        <select class="listvideos custom-select">
            <?php for ($i = 0; $i < count($videonb); $i++) { ?>
...
<!-- Fanpage -->
<div class="fb-page" data-href="<?= $optsetting['fanpage'] ?>" data-tabs="timeline" data-width="300" data-height="200"
...
<div class="js-facebook-messenger-container">
    ...
    <div class="fb-page" data-href="<?= $optsetting['fanpage'] ?>" data-tabs="messages" data-small-header="true"
        data-width="300" data-height="300" data-adapt-container-width="true" data-hide-cover="false"
...
<?php if ($type == 'script-main') { ?>
    ...
    (function(d, s, id) {
        ...
        js.id = id;
        js.async = true;
        js.src = "//connect.facebook.net/<?= $lang ?>_VN/sdk.js#xfbml=1&version=v2.6";
