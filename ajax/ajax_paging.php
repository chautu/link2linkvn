<?php 
	...
	$table = 'product';
	$type = 'san-pham';
	$column = "ten$lang as ten, tenkhongdau".$config['website']['lang-default'].", tenkhongdauen, gia, giamoi, giakm, photo";
	...
	if($idList)
	{
		...
		$list = $d->rawQueryOne("select tenkhongdau".$config['website']['lang-default'].", tenkhongdauen from #_$table_list where id = ? limit 0,1",array($idList));
	}
	$tempLink .= "&p=";
	$pageLink .= $tempLink;
