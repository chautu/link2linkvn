<?php
	...
	{
		global $d, $config, $func, $com, $type, $config;
		...
		{
			if(
				(isset($data['ten'.$config['website']['lang-default']]) && $data['ten'.$config['website']['lang-default']] != '') || 
				(isset($data['mota'.$config['website']['lang-default']]) && $data['mota'.$config['website']['lang-default']] != '') || 
				(isset($data['noidung'.$config['website']['lang-default']]) && $data['noidung'.$config['website']['lang-default']] != ''))
			{
				$data['ngaytao'] = time();
