<?php
	...
	$PHPExcel->setActiveSheetIndex(0)->setCellValue('A1',$setting['ten'.$config['website']['lang-default']]);
	...
	for($i=0;$i<count($donhang);$i++)
	{
		...
		->setCellValue('E'.$vitri, htmlspecialchars_decode($func->get_payments(@$donhang[$i]['httt'], $config['website']['lang-default'])))
