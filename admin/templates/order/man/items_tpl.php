        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?=$totalMoidat ? $func->format_money($totalMoidat) : 0?></span></p>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?=$totalDaxacnhan ? $func->format_money($totalDaxacnhan) : 0?></span></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?=$totalDagiao ? $func->format_money($totalDagiao) : 0?></span></p>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?=$totalDahuy ? $func->format_money($totalDahuy) : 0?></span></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                ...
                <div class="form-group col-md-3 col-sm-3">
                    ...
                    <?=$func->orderPayments($config['website']['lang-default'], false)?>
                </div>
                <div class="form-group col-md-3 col-sm-3">
                    <label>Tỉnh thành:</label>
                    <?=$func->get_ajax_place("city", $config['website']['lang-default'], false, "Chọn tỉnh thành")?>
                </div>
                <div class="form-group col-md-3 col-sm-3">
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span class="text-info"><?=$func->get_payments($items[$i]['httt'], $config['website']['lang-default'])?></span>
                                </td>
                                <td class="align-middle">
                                    <span class="text-danger font-weight-bold"><?=$func->format_money($items[$i]['tonggia'])?></span>
                                </td>
                                <td class="align-middle">
                                    <?= $func->get_status('status',$items[$i]['tinhtrang']) ?>
                                </td>
                                <?php if(
                                    (isset($config['order']['excel']) && $config['order']['excel'] == true) || 
                                    (isset($config['order']['word']) && $config['order']['word'] == true)
