        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
				...
				<div class="form-group col-md-4 col-sm-6">
					...
					<p class="text-info"><?=$func->get_payments(@$item['httt'], $config['website']['lang-default'])?></p>
				</div>
				<div class="form-group col-md-4 col-sm-6">
					<label>Họ tên:</label>
				...
				<?php if($item['guitang']) { ?> 
					...
					<div class="form-group col-12">
						<label for="thongdiep">Thông điệp:</label>
						<textarea class="form-control" name="data[thongdiep]" id="thongdiep" rows="5" placeholder="Thông điệp" readonly><?=@$item['thongdiep']?></textarea>
					</div>
				<?php } ?>
				<div class="form-group col-md-4 col-sm-6">
				...
				<div class="form-group col-12">
					...
					<textarea class="form-control" name="data[yeucaukhac]" id="yeucaukhac" rows="5" placeholder="Yêu cầu khác" readonly><?=@$item['yeucaukhac']?></textarea>
				</div>
				<div class="form-group col-12">
					<label for="tinhtrang" class="mr-2">Tình trạng:</label>
					<?=$func->orderStatus(@$item['tinhtrang'], $config['website']['lang-default'], true)?>
				</div>
				<div class="form-group col-12">
	            ...
	            <table class="table table-hover">
	                ...
	                <?php } else { ?>
	                    <tbody>
							...
							<?php if($item['giamgia']) { ?> 
							<tr>
								<td colspan="5" class="title-money-cart-detail">Áp dụng mã giảm giá <?= $item['magiamgia'] ?>:</td>
								<td colspan="1" class="cast-money-cart-detail">
									<?php if($item['giamgia']) { ?>
										<?=$func->format_money($item['giamgia'])?>
									<?php } else { ?>
										Không
									<?php } ?>
								</td>
