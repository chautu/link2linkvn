                            ...
                            <tr>
                                ...
                                <?php if(isset($config['tags'][$type]['show_images']) && $config['tags'][$type]['show_images'] == true) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['tags'][$type]['thumb']?>/<?=UPLOAD_TAGS_L.$items[$i]['photo']?>" alt="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"></a>
	                                </td>
	                            <?php } ?>
                                <td class="align-middle">
