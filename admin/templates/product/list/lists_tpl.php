                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <?php if(isset($config['product'][$type]['show_images_list']) && $config['product'][$type]['show_images_list'] == true) { ?>
                                    <td class="align-middle">
                                    	<a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['product'][$type]['thumb_list']?>/<?=UPLOAD_PRODUCT_L.$items[$i]['photo']?>" alt="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"></a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
