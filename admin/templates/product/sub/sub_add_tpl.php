                                        ...
                                        <div class="tab-pane fade show <?=($k==$config['website']['lang-default'])?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if(isset($config['product'][$type]['mota_sub']) && $config['product'][$type]['mota_sub'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control for-seo short <?=(isset($config['product'][$type]['mota_cke_sub']) && $config['product'][$type]['mota_cke_sub'] == true)?'form-control-ckeditor':''?>" name="data[mota<?=$k?>]" id="mota<?=$k?>" rows="5" placeholder="Mô tả (<?=$k?>)"><?=htmlspecialchars_decode(@$item['mota'.$k])?></textarea>
                                                </div>
                                            <?php } ?>
                    ...
                    <div class="card-body">
                        <div class="form-group-category row">
                            <div class="form-group col-sm-6">
                                ...
                                <?=$func->get_ajax_category('product', 'list', $type, $config['website']['lang-default'], true)?>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="d-block" for="id_cat">Danh mục cấp 2:</label>
                                <?=$func->get_ajax_category('product', 'cat', $type, $config['website']['lang-default'], true)?>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="d-block" for="id_item">Danh mục cấp 3:</label>
                                <?=$func->get_ajax_category('product', 'item', $type, $config['website']['lang-default'], true)?>
                            </div>
                        </div>
                    </div>
                </div>
