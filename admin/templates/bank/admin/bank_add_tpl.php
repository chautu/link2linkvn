<?php
    $linkSave = "index.php?com=user&act=save-bank-admin";
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0);" onclick="history.back();" title="Thêm ngân hàng">Thêm ngân hàng</a></li>
            </ol>
        </div>
    </div>
</section>
