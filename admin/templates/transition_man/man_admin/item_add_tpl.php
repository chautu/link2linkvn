        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                <div class="form-group col-md-12">
                    <label class="d-block" for="id_member">Chọn admin:</label>
                    <select name="data[id_user]" id="id_user" class="form-control select2 add_transition_member" required>
                        <option value="" disabled="" selected="" hidden="">Chọn admin</option>
