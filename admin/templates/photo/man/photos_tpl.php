            ...
            <table class="table table-hover">
                <thead>
                    <tr>
				        ...
				        <?php } ?>
                        <?php if(isset($config['photo']['man_photo'][$type]['show_icon_photo']) && $config['photo']['man_photo'][$type]['show_icon_photo'] == true) { ?>
                        	<th class="align-middle text-center" width="8%">Icon</th>
				        <?php } ?>
                            ...
                            <tr>
                                ...
                                <?php if(isset($config['photo']['man_photo'][$type]['avatar_photo']) && $config['photo']['man_photo'][$type]['avatar_photo'] == true) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['photo']['man_photo'][$type]['thumb_photo']?>/<?=UPLOAD_PHOTO_L.$items[$i]['photo']?>" alt="<?=$items[$i]['ten'.$config['website']['lang-default']]?>"></a>
	                                </td>
	                            <?php } ?>
                                <?php if(isset($config['photo']['man_photo'][$type]['show_icon_photo']) && $config['photo']['man_photo'][$type]['show_icon_photo'] == true) { ?>
                                	<td class="align-middle text-center"><i class="<?= $items[$i]['icon'] ?>"></i></td>
                                <?php } ?>
                                <?php if(isset($config['photo']['man_photo'][$type]['tieude_photo']) && $config['photo']['man_photo'][$type]['tieude_photo'] == true) { ?>
	                                <td class="align-middle">
