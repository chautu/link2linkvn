                ...
                <div class="row">
                    <?php if(isset($config['photo']['photo_static'][$type]['background']) && $config['photo']['photo_static'][$type]['background'] == true) { ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control select2" name="data[options][background][attachment]" id="background_attachment">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control select2" name="data[options][background][loaihienthi]" id="loaihienthi">
                                    ...
                                    <div class="tab-pane fade show <?=($k==$config['website']['lang-default'])?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                        ...
                                        <?php if((isset($config['photo']['photo_static'][$type]['mota']) && $config['photo']['photo_static'][$type]['mota'] == true)) { ?>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control short <?=((isset($config['photo']['photo_static'][$type]['mota_cke']) && $config['photo']['photo_static'][$type]['mota_cke'] == true))?'form-control-ckeditor':''?>" name="data[mota<?=$k?>]" id="mota<?=$k?>" rows="5" placeholder="Mô tả (<?=$k?>)"><?=htmlspecialchars_decode(@$item['mota'.$k])?></textarea>
                                            </div>
                                        <?php } ?>
