                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show <?=($k==$config['website']['lang-default'])?'active':''?>" id="tabs-lang-<?=$k?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo short <?=(isset($config['news'][$type]['mota_cke_list']) && $config['news'][$type]['mota_cke_list'] == true)?'form-control-ckeditor':''?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo <?=(isset($config['news'][$type]['noidung_cke_list']) && $config['news'][$type]['noidung_cke_list'] == true)?'form-control-ckeditor':''?>"
                                    ...
                                    <?php } ?>
                                    <?php if(isset($config['news'][$type]['code_list']) && $config['news'][$type]['code_list'] == true) { ?>
                                        <div class="form-group">
                                            <label for="code">Code:</label>
                                            <input type="text" class="form-control for-seo" name="data[code]" id="code"
                                                placeholder="Mã code" value="<?=@$item['code']?>"
                                                required>
                                        </div>
                                    <?php } ?>
                                </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="filer-gallery" class="label-filer-gallery mb-3">Album hình:
                        (<?=$config['news'][$type]['gallery_list'][$key]['img_type_photo']?>)</label>
