                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show <?=($k==$config['website']['lang-default'])?'active':''?>" id="tabs-lang-<?=$k?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo short <?=(isset($config['news'][$type]['mota_cke_sub']) && $config['news'][$type]['mota_cke_sub'] == true)?'form-control-ckeditor':''?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo <?=(isset($config['news'][$type]['noidung_cke_sub']) && $config['news'][$type]['noidung_cke_sub'] == true)?'form-control-ckeditor':''?>"
                    ...
                    <div class="card-body">
                        <div class="form-group-category row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <?=$func->get_ajax_category('news', 'item', $type, $config['website']['lang-default'], true)?>
                            </div>
                        </div>
                    </div>
                </div>
