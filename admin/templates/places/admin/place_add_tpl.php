<?php
    $linkSave = "index.php?com=user&act=save-address-admin";
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0);" onclick="history.back();" title="Thêm địa chỉ">Thêm địa chỉ</a></li>
            </ol>
        </div>
    </div>
</section>
