<?php
    $linkSave = "index.php?com=user&act=save-transition-man-admin&user=".$_GET['user']."&p=".$curPage;
    $linkMan = "index.php?com=user&act=edit_admin&id=".$_GET['user']."&p=".$curPage."&active=transition";
?>
<!-- Content Header -->
