<?php
    ...
    $linkDeletePhoto = "index.php?com=user&act=delete-photo-timeline-man-admin&p=".$curPage;
    $linkAddPhoto = "index.php?com=user&act=add-photo-timeline-man-admin&p=".$curPage;
    $linkEditPhoto = "index.php?com=user&act=edit-photo-timeline-man-admin&p=".$curPage;
?>
<!-- Content Header -->
