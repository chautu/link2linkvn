<?php
    $linkSave = "index.php?com=user&act=save-photo-timeline-man-admin&id-timeline=".$_GET['id-timeline']."&p=".$curPage."&user=".$_GET['user'];
    $linkMan = "index.php?com=user&act=edit-timeline-man-admin&p=".$curPage."&id=".$_GET['id-timeline']."&user=".$_GET['user'];
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><a href="<?= $linkMan ?>" title="Thêm giao dịch">Thêm hình ảnh mô tả</a></li>
            </ol>
        </div>
    </div>
</section>
