<?php
    $linkSave = "index.php?com=user&act=save-photo-timeline&id-timeline=".$_GET['id-timeline']."&p=".$curPage."&user=".$_GET['user'];
    $linkMan = "index.php?com=user&act=edit-timeline&p=".$curPage."&id=".$_GET['id-timeline']."&user=".$_GET['user'];
?>
<!-- Content Header -->
