...
$linkDeleteAddress = "index.php?com=user&act=delete-address-man-admin&p=".$curPage;
$linkAddAddress = "index.php?com=user&act=add-address-man-admin&p=".$curPage;
$linkEditAddress = "index.php?com=user&act=edit-address-man-admin&p=".$curPage;

$linkDeleteBank = "index.php?com=user&act=delete-bank-man-admin&p=".$curPage;
$linkAddBank = "index.php?com=user&act=add-bank-man-admin&p=".$curPage;
$linkEditBank = "index.php?com=user&act=edit-bank-man-admin&p=".$curPage;

$linkDeleteTransition = "index.php?com=user&act=delete-transition-man-admin&p=".$curPage;
$linkAddTransition = "index.php?com=user&act=add-transition-man-admin&p=".$curPage;
$linkEditTransition = "index.php?com=user&act=edit-transition-man-admin&p=".$curPage;

$linkDeleteTimeline = "index.php?com=user&act=delete-timeline-man-admin&p=".$curPage;
$linkAddTimeline = "index.php?com=user&act=add-timeline-man-admin&p=".$curPage;
$linkEditTimeline = "index.php?com=user&act=edit-timeline-man-admin&p=".$curPage;
								...
								<div class="row">
									<?php if(isset($config['permission']) && $config['permission'] == true) { ?>
										<div class="form-group col-md-4">
											...
											<?=$func->get_permission(@$item['id_nhomquyen'], true)?>
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="data[username]" id="username"
											placeholder="Tài khoản" value="<?=@$item['username']?>" <?=($act=="edit_admin")?'readonly':'';?>
											required>
									</div>
									<div class="form-group col-md-4">
												...
												<tbody>
													<?php foreach($transitions as $tr) { ?>
														...
														<tr>
															...
															<td class="align-middle text-center text-md text-nowrap">
																<a class="text-primary mr-2" href="<?=$linkEditTransition?><?=$linkID?>&id=<?=$tr['id']?>&user=<?= $item['id'] ?>" title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
