                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['username']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/170x170x1/<?=UPLOAD_USER_L.$items[$i]['avatar']?>" alt="<?=$items[$i]['username']?>"></a>
                                </td>
                                <td class="align-middle">
