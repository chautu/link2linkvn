    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
		            ...
		            <div class="card-body">
	            		<?php if(isset($value['list']) && $value['list'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-list-<?=$key?>"><?=$value['title_main_list']?>:</label>
								<div class="col-md-7">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-list-save-<?=$key?>" value="product_save_list<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_list'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-list-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['cat']) && $value['cat'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-cat-<?=$key?>"><?=$value['title_main_cat']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-cat-save-<?=$key?>" value="product_save_cat_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_cat_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-cat-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['item']) && $value['item'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-item-<?=$key?>"><?=$value['title_main_item']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-item-save-<?=$key?>" value="product_save_item_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_item_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-item-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['sub']) && $value['sub'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-sub-<?=$key?>"><?=$value['title_main_sub']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-sub-save-<?=$key?>" value="product_save_sub_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_sub_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-sub-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
		            	<?php if(isset($value['brand']) && $value['brand'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-brand-<?=$key?>"><?=$value['title_main_brand']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-brand-save-<?=$key?>" value="product_save_brand_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_brand_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-brand-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
		            	<?php } ?>
		            	<?php if(isset($value['attr']) && $value['attr'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-attr-<?=$key?>"><?=$value['title_main_attr']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attr-view-<?=$key?>" value="product_man_attr_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_attr_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attr-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attr-add-<?=$key?>" value="product_add_attr_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_attr_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attr-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attr-edit-<?=$key?>" value="product_edit_attr_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_attr_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attr-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attr-delete-<?=$key?>" value="product_delete_attr_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_attr_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attr-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attr-save-<?=$key?>" value="product_save_attr_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_attr_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attr-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
		            	<?php } ?>
		            	<?php if(isset($value['attributes']) && $value['attributes'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-attributes-<?=$key?>"><?=$value['title_main_attributes']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attributes-view-<?=$key?>" value="product_man_attributes_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_attributes_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attributes-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attributes-add-<?=$key?>" value="product_add_attributes_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_attributes_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attributes-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attributes-edit-<?=$key?>" value="product_edit_attributes_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_attributes_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attributes-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attributes-delete-<?=$key?>" value="product_delete_attributes_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_attributes_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attributes-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-attributes-save-<?=$key?>" value="product_save_attributes_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_attributes_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-attributes-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
		            	<?php } ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-save-<?=$key?>" value="product_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_save_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-product-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
						<?php if(isset($value['gallery']) && count($value['gallery']) > 0) { ?>
							<?php foreach($value['gallery'] as $keyv => $val) { ?> 
								<div class="form-group row">
									<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-photo-<?=$keyv?>"><?=$val['title_main_photo']?>:</label>
									<div class="col-md-7">
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-photo-view-<?=$keyv?>" value="product_man_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('product_man_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-product-photo-view-<?=$keyv?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-photo-add-<?=$keyv?>" value="product_add_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('product_add_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-product-photo-add-<?=$keyv?>" class="custom-control-label font-weight-normal">Thêm mới</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-photo-edit-<?=$keyv?>" value="product_edit_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('product_edit_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-product-photo-edit-<?=$keyv?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-photo-delete-<?=$keyv?>" value="product_delete_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('product_delete_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-product-photo-delete-<?=$keyv?>" class="custom-control-label font-weight-normal">Xóa</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-photo-save-<?=$keyv?>" value="product_save_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('product_save_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-product-photo-save-<?=$keyv?>" class="custom-control-label font-weight-normal">Save</label>
										</div>
									</div>
								</div>
							<?php } ?>
						...
						<?php if(isset($value['import']) && $value['import'] == true) { ?>
							<div class="form-group row">
								...
								<div class="col-md-7">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-import-saveImages-<?=$key?>" value="import_saveImages_<?=$key?>" <?=(isset($ds_quyen) && in_array('import_saveImages_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-import-saveImages-<?=$key?>" class="custom-control-label font-weight-normal">Save hình ảnh</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
        	...
        	<?php foreach($config['news'] as $key => $value) { if(isset($value['dropdown']) && $value['dropdown'] == true) { ?>
				<div class="card card-permission card-primary card-outline text-sm">
		            ...
		            <div class="card-body">
	            		<?php if(isset($value['list']) && $value['list'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-list-<?=$key?>"><?=$value['title_main_list']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-list-save-<?=$key?>" value="news_save_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('news_save_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-news-list-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['cat']) && $value['cat'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-cat-<?=$key?>"><?=$value['title_main_cat']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-cat-save-<?=$key?>" value="news_save_cat_<?=$key?>" <?=(isset($ds_quyen) && in_array('news_save_cat_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-news-cat-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['item']) && $value['item'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-item-<?=$key?>"><?=$value['title_main_item']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-item-save-<?=$key?>" value="news_save_item_<?=$key?>" <?=(isset($ds_quyen) && in_array('news_save_item_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-news-item-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
				                    </div>
								</div>
							</div>
						<?php } ?>
						<?php if(isset($value['sub']) && $value['sub'] == true) { ?>
							<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-sub-<?=$key?>"><?=$value['title_main_sub']?>:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
									...
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
						                <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-sub-save-<?=$key?>" value="news_save_sub_<?=$key?>" <?=(isset($ds_quyen) && in_array('news_save_sub_'.$key, $ds_quyen))?'checked':'';?>>
						                <label for="quyen-news-sub-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
						            </div>
								</div>
							</div>
						<?php } ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-save-<?=$key?>" value="news_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('news_save_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-news-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
						<?php if(isset($value['gallery']) && count($value['gallery']) > 0) { ?>
							<?php foreach($value['gallery'] as $keyv => $val) { ?> 
								<div class="form-group row">
									<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-news-photo-<?=$keyv?>"><?=$val['title_main_photo']?>:</label>
									<div class="col-md-7">
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-photo-view-<?=$keyv?>" value="news_man_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('news_man_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-news-photo-view-<?=$keyv?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-photo-add-<?=$keyv?>" value="news_add_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('news_add_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-news-photo-add-<?=$keyv?>" class="custom-control-label font-weight-normal">Thêm mới</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-photo-edit-<?=$keyv?>" value="news_edit_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('news_edit_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-news-photo-edit-<?=$keyv?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-photo-delete-<?=$keyv?>" value="news_delete_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('news_delete_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-news-photo-delete-<?=$keyv?>" class="custom-control-label font-weight-normal">Xóa</label>
										</div>
										<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
											<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-news-photo-save-<?=$keyv?>" value="news_save_photo_<?=$keyv?>" <?=(isset($ds_quyen) && in_array('news_save_photo_'.$keyv, $ds_quyen))?'checked':'';?>>
											<label for="quyen-news-photo-save-<?=$keyv?>" class="custom-control-label font-weight-normal">Save</label>
										</div>
									</div>
								</div>
							<?php } ?>
	            	...
	            	<?php if(isset($config['photo']['man_photo'])) { foreach($config['photo']['man_photo'] as $key => $value) { ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-man-photo-save-<?=$key?>" value="photo_save_photo_<?=$key?>" <?=(isset($ds_quyen) && in_array('photo_save_photo_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-man-photo-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
					<?php } } ?>
		...
		<?php if(isset($config['comments']['active']) && $config['comments']['active'] == true) { ?>
			<div class="card card-permission card-primary card-outline text-sm">
	            ...
	            <div class="card-body">
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-comments-view" value="comments_man" <?=(isset($ds_quyen) && in_array('comments_man', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-comments-view" class="custom-control-label font-weight-normal">Xem danh sách</label>
                    </div>
                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-comments-edit" value="comments_edit" <?=(isset($ds_quyen) && in_array('comments_edit', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-comments-edit" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
                    </div>
                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-comments-delete" value="comments_delete" <?=(isset($ds_quyen) && in_array('comments_delete', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-comments-delete" class="custom-control-label font-weight-normal">Xóa</label>
                    </div>
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-comments-save" value="comments_save" <?=(isset($ds_quyen) && in_array('comments_save', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-comments-save" class="custom-control-label font-weight-normal">Save</label>
                    </div>
	            </div>
	        </div>
		<?php } ?>
		<?php if(isset($config['coupons']['active']) && $config['coupons']['active'] == true) { ?>
			<div class="card card-permission card-primary card-outline text-sm">
	            ...
	            <div class="card-body">
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-coupons-view" value="coupons_man" <?=(isset($ds_quyen) && in_array('coupons_man', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-coupons-view" class="custom-control-label font-weight-normal">Xem danh sách</label>
                    </div>
                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-coupons-edit" value="coupons_edit" <?=(isset($ds_quyen) && in_array('coupons_edit', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-coupons-edit" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
                    </div>
                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-coupons-delete" value="coupons_delete" <?=(isset($ds_quyen) && in_array('coupons_delete', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-coupons-delete" class="custom-control-label font-weight-normal">Xóa</label>
                    </div>
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-coupons-save" value="coupons_save" <?=(isset($ds_quyen) && in_array('coupons_save', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-coupons-save" class="custom-control-label font-weight-normal">Save</label>
                    </div>
	            </div>
	        </div>
		<?php } ?>
		<?php if(isset($config['order']['active']) && $config['order']['active'] == true) { ?>
			<div class="card card-permission card-primary card-outline text-sm">
	            ...
	            <div class="card-body">
					...
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-order-save" value="order_save" <?=(isset($ds_quyen) && in_array('order_save', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-order-save" class="custom-control-label font-weight-normal">Save</label>
                    </div>
	            </div>
	        </div>
		<?php } ?>
	            	...
	            	<?php foreach($config['tags'] as $key => $value) { ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-tags-save-<?=$key?>" value="tags_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('tags_save_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-tags-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
					<?php } ?>
	            	...
	            	<?php foreach($config['newsletter'] as $key => $value) { ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-email-save-<?=$key?>" value="newsletter_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('newsletter_save_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-email-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
					<?php } ?>
	            	...
	            	<?php foreach($config['static'] as $key => $value) { ?>
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
			                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-static-save-<?=$key?>" value="static_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('static_save_'.$key, $ds_quyen))?'checked':'';?>>
			                        <label for="quyen-static-save-<?=$key?>" class="custom-control-label font-weight-normal">Save</label>
			                    </div>
							</div>
						</div>
					<?php } ?>
	            ...
	            <div class="card-body">
					<div class="form-group row">
						...
						<div class="col-md-7">
							...
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-places-city-save" value="places_save_city" <?=(isset($ds_quyen) && in_array('places_save_city', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-places-city-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-7">
							...
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-places-district-save" value="places_save_district" <?=(isset($ds_quyen) && in_array('places_save_district', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-places-district-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-7">
							...
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-places-wards-save" value="places_save_wards" <?=(isset($ds_quyen) && in_array('places_save_wards', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-places-wards-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-7">
							...
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-places-street-save" value="places_save_street" <?=(isset($ds_quyen) && in_array('places_save_street', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-places-street-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
	            </div>
		...
		<?php if(isset($config['transition']['active']) && $config['transition']['active'] == true) { ?>
			<div class="card card-permission card-primary card-outline text-sm">
	            <div class="card-header">
	                <h3 class="card-title">Quản lý số dư</h3>
	                <div class="card-tools">
	                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
	                </div>
	            </div>
	            <div class="card-body">
					<div class="form-group row">
						<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-places-city">Số dư admin:</label>
						<div class="col-md-7">
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_admin-view" value="transition_man_admin" <?=(isset($ds_quyen) && in_array('transition_man_admin', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_admin-view" class="custom-control-label font-weight-normal">Xem danh sách</label>
		                    </div>
		                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_admin-add" value="transition_add_admin" <?=(isset($ds_quyen) && in_array('transition_add_admin', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_admin-add" class="custom-control-label font-weight-normal">Thêm mới</label>
		                    </div>
		                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_admin-edit" value="transition_edit_admin" <?=(isset($ds_quyen) && in_array('transition_edit_admin', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_admin-edit" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
		                    </div>
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_admin-save" value="transition_save_admin" <?=(isset($ds_quyen) && in_array('transition_save_admin', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_admin-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
					<div class="form-group row">
						<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-transition-district">Số dư khách:</label>
						<div class="col-md-7">
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_mem-view" value="transition_man_mem" <?=(isset($ds_quyen) && in_array('transition_man_mem', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_mem-view" class="custom-control-label font-weight-normal">Xem danh sách</label>
		                    </div>
		                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_mem-add" value="transition_add_mem" <?=(isset($ds_quyen) && in_array('transition_add_mem', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_mem-add" class="custom-control-label font-weight-normal">Thêm mới</label>
		                    </div>
		                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_mem-edit" value="transition_edit_mem" <?=(isset($ds_quyen) && in_array('transition_edit_mem', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_mem-edit" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
		                    </div>
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-transition-man_mem-save" value="transition_save_mem" <?=(isset($ds_quyen) && in_array('transition_save_mem', $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-transition-man_mem-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					</div>
	            </div>
	    ...
	    <?php if(isset($config['onesignal']) && $config['onesignal'] == true) { ?>
			<div class="card card-permission card-primary card-outline text-sm">
	            ...
	            <div class="card-body">
					...
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-onesignal-save" value="pushOnesignal_save" <?=(isset($ds_quyen) && in_array('pushOnesignal_save', $ds_quyen))?'checked':'';?>>
                        <label for="quyen-onesignal-save" class="custom-control-label font-weight-normal">Save</label>
                    </div>
	            </div>
	        </div>
		<?php } ?>
	            ...
	            <div class="card-body">
					<?php foreach($config['seopage']['page'] as $key => $value) { ?>
						<div class="form-group row">
							...
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-seopage-<?=$key?>-capnhat" value="seopage_capnhat_<?=$key?>" <?=(isset($ds_quyen) && in_array('seopage_capnhat_'.$key, $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-seopage-<?=$key?>-capnhat" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
		                    </div>
							<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-seopage-<?=$key?>-save" value="seopage_save_<?=$key?>" <?=(isset($ds_quyen) && in_array('seopage_save_'.$key, $ds_quyen))?'checked':'';?>>
		                        <label for="quyen-seopage-<?=$key?>-save" class="custom-control-label font-weight-normal">Save</label>
		                    </div>
						</div>
					<?php } ?>
	            </div>
		...
		<div class="card card-permission card-primary card-outline text-sm">
            ...
            <div class="card-body">
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-man" value="lang_man" <?=(isset($ds_quyen) && in_array('lang_man', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-man" class="custom-control-label font-weight-normal">Xem danh sách</label>
				</div>
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-add" value="lang_add" <?=(isset($ds_quyen) && in_array('lang_add', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-add" class="custom-control-label font-weight-normal">Thêm mới</label>
				</div>
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-edit" value="lang_edit" <?=(isset($ds_quyen) && in_array('lang_edit', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-edit" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				</div>
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-delete" value="lang_delete" <?=(isset($ds_quyen) && in_array('lang_delete', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-delete" class="custom-control-label font-weight-normal">Xoá</label>
				</div>
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-save" value="lang_save" <?=(isset($ds_quyen) && in_array('lang_save', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-save" class="custom-control-label font-weight-normal">Save</label>
				</div>
				<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
					<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-lang-create" value="lang_create" <?=(isset($ds_quyen) && in_array('lang_create', $ds_quyen))?'checked':'';?>>
					<label for="quyen-lang-create" class="custom-control-label font-weight-normal">Tạo tệp tin</label>
				</div>
            </div>
        </div>
	    <div class="card card-permission card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title">Quản lý Setting Page</h3>
                <div class="card-tools">
                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                </div>
            </div>
            <div class="card-body">
				<div class="form-group">
					...
					<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
		                <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-setting-save" value="setting_save" <?=(isset($ds_quyen) && in_array('setting_save', $ds_quyen))?'checked':'';?>>
		                <label for="quyen-setting-save" class="custom-control-label font-weight-normal">Save</label>
		            </div>
				</div>
            </div>
        </div>
